...
const all$1 = require("./all-SkrwsBgI.js");
...
styled.styled(designSystem.Typography)`
  ...
  word-break: break-all;
`;
styled.styled(designSystem.SubNav)`
  background-color: ${({ theme }) => theme.colors.neutral0};
...
const HomePage = () => {
  const { get: get2, put, del, post } = admin$1.useFetchClient();
  const [iconLibraries, setIconLibraries] = React.useState([]);
  const getIconLibraries = async () => {
    setIconLibraries([...(await get2("/strapi-icon-picker/iconlibrary/find")).data]);
  };
  const updateIconLibrary = async (id, isEnabled) => {
    await put(`/strapi-icon-picker/iconlibrary/update/${id}`, {
      data: { isEnabled }
    });
  ...
  const deleteIconLibrary = async (id) => {
    await del(`/strapi-icon-picker/iconlibrary/delete/${id}`);
    setIconLibraries((current) => current.filter((iconLibrary) => iconLibrary.id !== id));
  };
  const importDefaultIconLibraries = async () => {
    (await Promise.resolve().then(() => require("./default-BYF3z7Xg.js"))).default.forEach(async (entry) => {
      await post("/strapi-icon-picker/iconlibrary/post", {
        data: entry
      });
    });
    getIconLibraries();
  ...
  const getIconCount = (abbreviation) => {
    return Object.keys(all$1.ReactIcons).filter((icon) => icon.toLowerCase().startsWith(abbreviation)).length;
  };
    ...
    designSystem.Box,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          Layouts.Header,
          {
            title: "strapi-icon-picker",
            subtitle: "Select the strapi-icon-picker libraries you want to have enabled.",
            primaryAction: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: importDefaultIconLibraries, children: "Import default icon libraries" })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(
          Layouts.Action,
          {
            startActions: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Button,
                {
                  onClick: () => iconLibraries.filter((iconLibrary) => iconLibrary.isEnabled).forEach((iconLibrary) => updateIconLibrary(iconLibrary.id, false)),
                  variant: "secondary",
                  children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 5, children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Button,
                {
                  onClick: () => iconLibraries.forEach((iconLibrary) => deleteIconLibrary(iconLibrary.id)),
                  variant: "danger",
                  children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 5, children: [
                    /* @__PURE__ */ jsxRuntime.jsx(bi.BiTrash, {}),
                    "Delete all"
        ...
        /* @__PURE__ */ jsxRuntime.jsx(Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 4, rowCount: iconLibraries.length, children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: "is enabled" }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: "abbreviation" }) }),
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", children: "icon count" }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: "Actions" })
          ] }) }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: iconLibraries.length > 0 ? iconLibraries.sort((a2, b2) => Number(b2.isEnabled) - Number(a2.isEnabled)).map((iconLibrary) => {
            return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: iconLibrary.abbreviation }) }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: iconLibrary.name }) }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: getIconCount(iconLibrary.abbreviation) }) }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Button,
                {
          ...
          }) : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 5, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", children: "No icon libraries added yet" }) }) })
        ] }) })
      ]
    }
  );
...
exports.App = App;
//# sourceMappingURL=App-Bk_tZKEq.js.map
