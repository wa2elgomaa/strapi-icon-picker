...
import { g as getTrad } from "./index-u3V5S1Jr.mjs";
...
const ReactIconsSelector = ({
  ...
  const renderModal = () => {
    return /* @__PURE__ */ jsxs(
      Modal.Root,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Modal.Trigger, { style: { padding: "3px" }, children: /* @__PURE__ */ jsx(BiSearch, { width: 30, height: 30, style: { cursor: "pointer" } }) }),
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(Field.Root, { name, id: name, error: field.error, required, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 1, children: [
    /* @__PURE__ */ jsx(Field.Label, { action: labelAction, children: "dsss" }),
    /* @__PURE__ */ jsx(
      Field.Input,
      {
        ...props,
...
//# sourceMappingURL=index-BKgkRLTC.mjs.map
