...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-Bbci_PVf.mjs");
        return App;
      },
      permissions: [
        {
...
//# sourceMappingURL=index-CxxftIK0.mjs.map
