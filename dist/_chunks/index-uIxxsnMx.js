...
const index = require("./index-nbBS8_ZI.js");
...
const ReactIconsSelector = ({
  ...
  const renderModal = () => {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.Modal.Root,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Trigger, { style: { padding: "3px" }, children: /* @__PURE__ */ jsxRuntime.jsx(bi.BiSearch, { width: 30, height: 30, style: { cursor: "pointer" } }) }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Root, { name, id: name, error: field.error, required, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 1, children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { action: labelAction, children: "dsss" }),
    /* @__PURE__ */ jsxRuntime.jsx(
...
//# sourceMappingURL=index-uIxxsnMx.js.map
