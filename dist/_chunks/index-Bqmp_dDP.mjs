...
import { g as getTrad } from "./index-DuLNooL2.mjs";
  ...
  const renderModal = () => {
    return /* @__PURE__ */ jsxs(
      Modal.Root,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Modal.Trigger, { style: { padding: "3px" }, children: /* @__PURE__ */ jsx(BiSearch, { width: 30, height: 30, style: { cursor: "pointer", width: 30, height: 30 } }) }),
...
//# sourceMappingURL=index-Bqmp_dDP.mjs.map
