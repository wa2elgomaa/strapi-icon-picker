...
import { Flex, Popover, Box, Typography, Button, LinkButton, Link, Portal, Alert, useCallbackRef, Field, SubNav, Badge, Table, Thead, Tr, Th, Tbody, Td, Checkbox } from "@strapi/design-system";
...
const HomePage = () => {
  const { get: get2, put, del, post } = useFetchClient();
  ...
  const importDefaultIconLibraries = async () => {
    (await import("./default-D_8P62HY.mjs")).default.forEach(async (entry) => {
  ...
  const getIconCount = (abbreviation) => {
    return Object.keys(ReactIcons).filter((icon) => icon.toLowerCase().startsWith(abbreviation)).length;
  };
      ...
      children: [
        /* @__PURE__ */ jsx(
          Layouts.Header,
          {
            ...
            primaryAction: /* @__PURE__ */ jsx(Button, { onClick: importDefaultIconLibraries, children: "Import default icon libraries" })
          }
        ),
        /* @__PURE__ */ jsx(
          Layouts.Action,
            ...
            startActions: /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(
                Button,
                {
                  ...
                  variant: "secondary",
                  children: /* @__PURE__ */ jsxs(Flex, { gap: 5, children: [
        ...
        /* @__PURE__ */ jsx(Layouts.Content, { children: /* @__PURE__ */ jsxs(Table, { colCount: 4, rowCount: iconLibraries.length, children: [
          /* @__PURE__ */ jsx(Thead, { children: /* @__PURE__ */ jsxs(Tr, { children: [
            /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: "is enabled" }) }),
            /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: "abbreviation" }) }),
            /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: "name" }) }),
            /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: "icon count" }) }),
            /* @__PURE__ */ jsx(Th, { children: "Actions" })
          ] }) }),
          /* @__PURE__ */ jsx(Tbody, { children: iconLibraries.length > 0 ? iconLibraries.sort((a2, b2) => Number(b2.isEnabled) - Number(a2.isEnabled)).map((iconLibrary) => {
            return /* @__PURE__ */ jsxs(Tr, { children: [
              ...
              /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: iconLibrary.abbreviation }) }),
              /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: iconLibrary.name }) }),
              /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: getIconCount(iconLibrary.abbreviation) }) }),
              /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(
                Button,
                {
          ...
          }) : /* @__PURE__ */ jsx(Box, { padding: 5, children: /* @__PURE__ */ jsx(Typography, { variant: "pi", children: "No icon libraries added yet" }) }) })
        ] }) })
      ]
    }
  );
...
//# sourceMappingURL=App-Bbci_PVf.mjs.map
