...
const index = require("./index-B951zCJj.js");
...
const ReactIconsSelector = ({
  ...
  const renderModal = (selectedIcon2) => {
    const DynamicIconComponent = all.ReactIcons[selectedIcon2];
    return /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.Modal.Root,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Trigger, { children: typeof DynamicIconComponent !== "undefined" ? /* @__PURE__ */ jsxRuntime.jsx(DynamicIconComponent, { size: 30, style: { cursor: "pointer", width: 30, height: 30 } }) : /* @__PURE__ */ jsxRuntime.jsx(bi.BiSearch, { width: 30, height: 30, style: { cursor: "pointer", width: 30, height: 30 } }) }),
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Body, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SearchForm, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { children: expandedIDs.length ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { size: "L", onClick: handleExpand, startIcon: /* @__PURE__ */ jsxRuntime.jsx(bi.BiMinus, {}), children: "Collapse All" }) : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { size: "L", onClick: handleExpand, startIcon: /* @__PURE__ */ jsxRuntime.jsx(bi.BiPlus, {}), children: "Expand All" }) }, 2)
              ] }) }),
              iconLibraries.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 4, marginTop: 2, background: "neutral0", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Accordion.Root, { collapsible: true, children: iconLibraries.filter(
                ...
                (iconLibrary) => allReactIcons.filter(
                      ...
                      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion.Header, { children: [
                        /* @__PURE__ */ jsxRuntime.jsxs(
                          designSystem.Accordion.Trigger,
                          {
                            caretPosition: "left",
                            children: [
                              expandedIDs.includes(iconLibrary.id) ? "in" : "out",
                              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "space-between", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { children: `${iconLibrary.name} (${iconLibrary.abbreviation})` }) })
                            ]
                          }
                        ),
...
//# sourceMappingURL=index-CJXytQOQ.js.map
