...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BDX2lfh5.js"));
        return App;
      },
      permissions: [
        {
...
exports.index = index;
//# sourceMappingURL=index-B8iuZokq.js.map
