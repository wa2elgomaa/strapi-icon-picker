...
const index = require("./index-B8iuZokq.js");
...
const ReactIconsSelector = ({
  ...
  const renderIcon = (selectedIcon2) => {
    if (selectedIcon2) {
      const DynamicIconComponent = all.ReactIcons[selectedIcon2];
      if (typeof DynamicIconComponent !== "undefined") {
        return /* @__PURE__ */ jsxRuntime.jsx(DynamicIconComponent, { size: 30, style: { cursor: "pointer", width: 30, height: 30 } });
      } else {
        return "";
      }
    }
    return /* @__PURE__ */ jsxRuntime.jsx(bi.BiSearch, { width: 30, height: 30, style: { cursor: "pointer", width: 30, height: 30 } });
  };
  const renderModal = (selectedIcon2) => {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.Modal.Root,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Trigger, { children: renderIcon(selectedIcon2) }),
...
//# sourceMappingURL=index-rM6Eluyw.js.map
