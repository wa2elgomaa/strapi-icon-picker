...
import { g as getTrad } from "./index-Uxw_mvWp.mjs";
  ...
  const renderIcon = (selectedIcon2) => {
    if (selectedIcon2) {
      ...
      if (typeof DynamicIconComponent !== "undefined") {
        return /* @__PURE__ */ jsx(DynamicIconComponent, { size: 30, style: { cursor: "pointer", width: 30, height: 30 } });
      } else {
        return "";
      }
    }
    return /* @__PURE__ */ jsx(BiSearch, { width: 30, height: 30, style: { cursor: "pointer", width: 30, height: 30 } });
  };
  const renderModal = (selectedIcon2) => {
    return /* @__PURE__ */ jsxs(
      Modal.Root,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Modal.Trigger, { children: renderIcon(selectedIcon2) }),
...
//# sourceMappingURL=index-CHdSX6xk.mjs.map
