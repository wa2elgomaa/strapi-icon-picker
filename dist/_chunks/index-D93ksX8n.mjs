...
import { g as getTrad } from "./index-CxxftIK0.mjs";
...
const ReactIconsSelector = ({
  ...
  const renderModal = () => {
    return /* @__PURE__ */ jsxs(
      Modal.Root,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Modal.Trigger, { children: /* @__PURE__ */ jsx(BiSearch, { width: 30, height: 30, style: { cursor: "pointer", width: 30, height: 30 } }) }),
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(Field.Root, { name, id: name, error: field.error, required, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 1, style: { paddingLeft: "3px" }, children: [
...
//# sourceMappingURL=index-D93ksX8n.mjs.map
